  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-base font-bold text-gray-900">Potential Matches</h2>
      ...
      <div className="space-y-3">
        ...
        <button className="w-full mt-4 text-blue-600 hover:text-blue-800 font-medium text-sm py-2 border border-blue-200 rounded-lg transition-colors">
          View All Matches
        </button>
      </div>
    </div>
