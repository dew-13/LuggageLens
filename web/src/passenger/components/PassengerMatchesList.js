          ...
          <div key={match.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div className="p-4">
              ...
              <div className="flex gap-2">
                <button className="flex-1 bg-blue-600 text-white py-2 px-3 rounded font-medium text-xs hover:bg-blue-700 transition-colors">
                  Confirm
                </button>
                <button className="flex-1 bg-gray-200 text-gray-900 py-2 px-3 rounded font-medium text-xs hover:bg-gray-300 transition-colors">
                  Not a Match
                </button>
              </div>
            </div>
